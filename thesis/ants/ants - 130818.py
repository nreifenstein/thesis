                ...
                if len(a_list) > 0:
                        ...
                        while not placed:
                            ...
                            if (random.randint(0,100) < self.param[0]) :
                                ...
                                else: self.hist[g].val[new_cell][0:3] = [4,-1,0]
                                placed = True
                            else:
                                # perform operation A                            
                                print " access,",
                                if  ((depth <= 3*min_size)) or (random.uniform(0,1) > self.param[20]):
                                    # make a built piece + access
                                    print " built"
                                    if (depth <= 3*min_size):
                                        new_cell = c_target[0]
                                    else:
                                    ...
                                    # extend access
                                    if (depth <= 2*min_size):
                                        self.hist[g].val[c_target[0]][0:3] = [2,-1,0]
                                        placed = True
                                    else:
                                        ...
                                        if no_zones < 2:
                                            ...
                                            zones = random.choice(range(1,no_zones))
                                        ...
                                        self.hist[g].val[new_access][0:3] = [2,-1,0]
                                        self.hist[g].val[new_cell][0:3] = [new_val,-1,0]
                                        depth = depth-new_size
                                        if depth < min_size: placed = True
